...
<head>
  ...
  <link rel="stylesheet" href="../css/estiloBTE.css">
</head>
<body>
...
<div class="contenedor">
  <div class="parqueo" id="parqueo1">
    <div class="contenido-parqueo"><img src="Reportar algun problema</div>
  </div>
  <div class="parqueo" id="parqueo2">
    <div class="contenido-parqueo">Soporte</div>
  </div>
  <div class="parqueo" id="parqueo3">
    <div class="contenido-parqueo">Editar parqueos</div>
  </div>     
</div>
