            ...
            <div class="mb-4 lg:mb-0">
                <div x-data="{ isOpen: false}" class="relative">
                    ...
                    <button @click="isOpen = !isOpen"
                        ...
                        <span class="mx-1"><?php echo htmlspecialchars($email); ?></span>
                    ...
                    <div x-show="isOpen" @click.away="isOpen = false"
                        ...
                        <a href="#"
                            ...
                            <img class="flex-shrink-0 object-cover mx-1 rounded-full w-9 h-9"
                                ...
                                alt="Jane Doe avatar">
                            <div class="mx-1">
                                <h1 class="text-sm font-semibold text-gray-700 dark:text-gray-200"><?php echo htmlspecialchars($email); ?></h1>
...
<script>
    ...
    <main class="container mx-auto p-6">
        <div class="bg-white p-6 rounded-lg shadow-md">
            ...
            <p class="mb-2"><strong>Nombre:</strong> <?php echo htmlspecialchars($user['nombre']); ?></p>
            <p class="mb-2"><strong>Apellido:</strong> <?php echo htmlspecialchars($user['apellido']); ?></p>
