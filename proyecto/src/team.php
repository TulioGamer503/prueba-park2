...
<section class="bg-white dark:bg-gray-900">
    ...
    <div class="container px-6 py-10 mx-auto">
        <h1 class="text-2xl font-semibold text-center text-gray-800 capitalize lg:text-3xl dark:text-white">Nuestro <span class="text-blue-500">Equipo Ejecutivo</span></h1>

        <p class="max-w-2xl mx-auto my-6 text-center text-gray-500 dark:text-gray-300">
        Conoce al equipo de liderazgo que impulsa nuestra visión y misión. Estamos orgullosos de contar con un grupo de profesionales altamente calificados, cada uno de ellos aportando una experiencia y perspectiva única que enriquece nuestro trabajo diario.
        </p>
        ...
        <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-2">
            <div class="px-12 py-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-600 dark:border-gray-700 dark:hover:border-transparent">
                <div class="flex flex-col sm:-mx-4 sm:flex-row">
                    ...
                    <div class="mt-4 sm:mx-4 sm:mt-0">
                        <h1 class="text-xl font-semibold text-gray-700 capitalize md:text-2xl dark:text-white group-hover:text-white">Victor Rivas</h1>

                        <p class="mt-2 text-gray-500 capitalize dark:text-gray-300 group-hover:text-gray-300">Diseñador</p>
                    </div>
                </div>

                <p class="mt-4 text-gray-500 capitalize dark:text-gray-300 group-hover:text-gray-300">Victor es el corazón creativo de nuestro equipo. Con una sólida experiencia en diseño gráfico y dirección artística, lidera nuestro equipo de diseño para garantizar que cada proyecto no solo cumpla con las expectativas de nuestros clientes, sino que las supere. Su pasión por el diseño y su compromiso con la excelencia son evidentes en cada aspecto de su trabajo.</p>
            ...
            <div class="px-12 py-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-600 dark:border-gray-700 dark:hover:border-transparent">
                <div class="flex flex-col sm:-mx-4 sm:flex-row">
                    ...
                    <div class="mt-4 sm:mx-4 sm:mt-0">
                        <h1 class="text-xl font-semibold text-gray-700 capitalize md:text-2xl dark:text-white group-hover:text-white">Julio Jacinto</h1>

                        <p class="mt-2 text-gray-500 capitalize dark:text-gray-300 group-hover:text-gray-300">Desarrollador</p>
                    </div>
                </div>

                <p class="mt-4 text-gray-500 capitalize dark:text-gray-300 group-hover:text-gray-300">Julio es nuestra experta en desarrollo de software, responsable de la implementación técnica y el mantenimiento de nuestras soluciones digitales. Con una amplia experiencia en desarrollo de software y un profundo conocimiento de las últimas tecnologías, Julio asegura que nuestros productos sean robustos, eficientes y estén a la vanguardia de la industria.</p>
            ...
            <div class="px-12 py-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-600 dark:border-gray-700 dark:hover:border-transparent">
                <div class="flex flex-col sm:-mx-4 sm:flex-row">
                    ...
                    <div class="mt-4 sm:mx-4 sm:mt-0">
                        <h1 class="text-xl font-semibold text-gray-700 capitalize md:text-2xl dark:text-white group-hover:text-white">Cesar Serrano</h1>

                        <p class="mt-2 text-gray-500 capitalize dark:text-gray-300 group-hover:text-gray-300">Desarrollador</p>
                    </div>
                </div>

                <p class="mt-4 text-gray-500 capitalize dark:text-gray-300 group-hover:text-gray-300">Cesar complementa al equipo de desarrollo con su experiencia y habilidades técnicas. Su enfoque en la solución de problemas y su habilidad para adaptar las últimas tecnologías a nuestras necesidades garantizan que cada proyecto se ejecute con precisión y eficacia.</p>
            ...
            <div class="px-12 py-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-600 dark:border-gray-700 dark:hover:border-transparent">
                <div class="flex flex-col sm:-mx-4 sm:flex-row">
                    ...
                    <div class="mt-4 sm:mx-4 sm:mt-0">
                        <h1 class="text-xl font-semibold text-gray-700 capitalize md:text-2xl dark:text-white group-hover:text-white">Fernando Moreno</h1>

                        <p class="mt-2 text-gray-500 capitalize dark:text-gray-300 group-hover:text-gray-300">Documentación y Diseñador
                        </p>
                    </div>
                </div>

                <p class="mt-4 text-gray-500 capitalize dark:text-gray-300 group-hover:text-gray-300">Fernando se encarga de la documentación y el diseño, asegurando que toda la información relevante esté clara y accesible. Su habilidad para combinar la claridad en la documentación con un diseño atractivo ayuda a que nuestros proyectos sean comprensibles y visualmente agradables.</p>
