        ...
        <div class="container mx-auto flex px-8 xl:px-0">
            ...
            <div id="menu"
                ...
                <div class="flex flex-col lg:flex-row mb-8 lg:mb-0">
                    ...
                    <a href="#" class="text-white lg:mr-7 mb-8 lg:mb-0">Estacionar</a>
                    <a href="#" class="text-white lg:mr-7 mb-8 lg:mb-0">Nosotros</a>
                    <a href="#" class="text-white ">Nosotros</a>
                </div>
                <div class="flex flex-col lg:flex-row text-center mb-8 lg:mb-0 ">
                    <a href="#"
                        class="text-white border border-white py-2.5 px-5 rounded-md hover:bg-white hover:text-black transition duration-500 ease-in-out lg:mr-4 mb-8 lg:m-0 ">Iniciar
                        Sesion</a>
                    <a href="#"
                        class="text-white bg-blue-500 border border-blue-500 py-2.5 px-5 rounded-md hover:bg-blue-600 hover:border-blue-600 transition duration-500 ease-in-out">Regiristare</a>
                </div>
            </div>
            ...
            <div class="lg:flex">
                <div class="w-full -mx-6 lg:w-2/5">
                    <div class="px-6">
                        ...
                        <p class="max-w-sm mt-2  text-gray-400">Join 31,000+ other and never miss out on new tips,
                            tutorials, and more.</p>

                        <div class="flex mt-6 -mx-2">
                            <a href="#" class="mx-2 text-gray-300  hover:text-blue-400" aria-label="Reddit">
                            ...
                            <a href="#" class="mx-2 text-gray-300  hover:text-blue-400" aria-label="Facebook">
                                <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                            ...
                            <a href="#" class="mx-2  text-gray-300  hover:text-blue-400" aria-label="Github">
                                <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
