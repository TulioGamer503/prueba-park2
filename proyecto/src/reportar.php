...
<nav class="bg-gray-800 py-6 relative">
                        ...
                        <div x-show="isOpen" @click.away="isOpen = false"
                            ...
                            <a href="#"
                                ...
                                <div class="mx-1">
                                    ...
                                    <p class="text-sm text-gray-500 dark:text-gray-400"><?php echo htmlspecialchars($nombre_usuario); ?><</p>
                                </div>
                            </a>
        ...
        <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 gap-x-16 gap-y-8 lg:grid-cols-5">
                <div class="lg:col-span-2 lg:py-12">
                    <div class="mt-8">
                        <h1 class="text-2xl font-bold text-red-600"> Reportar Problema </h1>
                    </div>
                    <p class="max-w-xl text-lg">
                        Si experimentas algún problema con el estacionamiento utilizando nuestra aplicación, no dudes en
                        informarnos.
                        Tu feedback es esencial para nosotros y nos ayuda a mejorar continuamente nuestros servicios.
                    </p>
                </div>
                ...
                <div class="rounded-lg bg-white p-8 shadow-lg lg:col-span-3 lg:p-12">
                    <form action="#" class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea class="w-full rounded-lg border-black p-3 text-sm" placeholder="Mensaje" rows="8"
                                id="message"></textarea>
                        </div>
    ...
    <footer class="bg-gray-900">
        <div class="container p-6 mx-auto">
                ...
                <div class="w-full -mx-6 lg:w-2/5">
                    <div class="px-6">
                        ...
                        <div class="flex mt-6 -mx-2">
                            <a href="#" class="mx-2 text-gray-300 hover:text-blue-500 dark:hover:text-blue-400"
                                aria-label="Reddit">
            ...
            <hr class="h-px my- border-none bg-gray-700">
